...
| 4   | **Jinja2-aware Formatting** — format any Jinja2 template (`.html`, `.jinja2`, `.j2`, `.jinja`) on save or on demand. The extension auto-detects `prettier-plugin-jinja-template` in your project and delegates formatting to it — best-in-class Jinja2+HTML formatting, zero custom parser maintenance. If the plugin isn't found, the extension offers to install it automatically. | Net-new (integration)      | Aug 2026 | ❌ Planned |
